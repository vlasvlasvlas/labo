# script para estudiantes avanzados
...
for( vmaxdepth in  c( 4,5,6,7,8,9,10,11 )  )
{
  param_basicos  <- list( "cp"=         -1,  #valor arbitrario, intencionalmente negativo para probar algo distinto a la manada
                          "minssplit"= 300,  #valor arbitrario
                          "minbucket"= 100,  #valor arbitrario
  ...
  #le agrego al final de tb_resultados el registro compuesto por  < vmaxdepth, gan >
