...
# sumo pagos minimos como drift (prueba)
# #https://en.wikipedia.org/wiki/Concept_drift

campos_buenos  <- setdiff( colnames(dataset), 
                           c("clase_ternaria","clase01",
                             #probando drift fotomes
                             "foto_mes" #estatica para este añomes
                             ) 
...
# lightgbm
# entrenando con POS = { BAJA+2, BAJA+1 } , NEG= {CONTINUA }
# Sin feature Engineering (por ahora)
...
archivo_salida  <- "labo\\exp\\KA2512/KA_512_021.csv"
